...
pacientes.forEach(function (paciente) {
    if('No confirmado' == paciente['Estado'] || 'Agenda Online' == paciente['Estado']){
        ...
        whatsapp += "%0A%0AAdjuntamos%20el%20documento%20necesario%20para%20poder%20movilizarse%20en%20fase%201%20http://justbetter.cl/youapp/public/youapp/public/pdf/"+nr
