...
class Appointment extends Model
{
    ...
    public static function tomorrow_appoiments()
    {
        ...
        return DB::select( DB::raw("select * from appointments as a where  id in (SELECT id FROM appointments where Fecha = '".$tomorrow."'  group by Tratamiento_Nr) and Estado in ('No Confirmado','Agenda Online') order by Hora_inicio asc") );
    }
