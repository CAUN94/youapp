...
class Appointment extends Model
{
    ...
    public static function tomorrow_appoiments()
    {
        ...
        return DB::select( DB::raw("select a.Profesional , Estado,Nombre_paciente,Apellidos_paciente,Celular,Hora_inicio,TotalAtencion+Avance,Mail from appointments as a join treatments
