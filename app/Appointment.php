...
class Appointment extends Model
{
    ...
    public static function tomorrow_appoiments()
    {
        ...
        return DB::select( DB::raw("select Estado,Nombre_paciente,Apellidos_paciente,Celular,Hora_inicio,TotalAtencion,Mail from appointments as a join treatments
